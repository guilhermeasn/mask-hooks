        ...
        <div className='bg-dark text-light py-5 px-3'>
            ...
            <div className='container'>
                ...
                <div className='text-right mb-5 d-flex flex-row-reverse'>
                    <a href='https://github.com/guilhermeasn/mask-hooks' target='_blank' rel="noreferrer" className='mx-3 mt-1'>
                    ...
                    <div>
                        <h3 className='m-0 p-0'>mask-hooks</h3>
                ...
                <div className='row'>
                    ...
                    <p className='col-12'>Target: <br/><input className='form-control rounded' onKeyDown type='text' value={ cVal } onChange={ input => {setCVal(input.currentTarget.value); } } /></p>
                </div>
